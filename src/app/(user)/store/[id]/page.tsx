  ...
  return (
    ...
    <div className=" container flex flex-col px-5 sm:px-[70px] gap-y-6 flex-1 mb-4">
      <div id="point-view" className=" flex flex-col lg:flex-row gap-y-16">
        <div id="profile-header" className="flex flex-[0.7] gap-x-5 flex-col items-center lg:items-start gap-y-6">
          ...
          <div id="profile" className="w-[80%] bg-stone-50/30 rounded-2xl shadow-lg px-3"> 
            <CardProfile {...sheet.seller} {...sheet}/>
          </div>
        </div>
        <div id="content" className="flex-1 flex flex-col p-2 md:pl-5 md:py-0 gap-0.5 md:gap-y-2">
          ...
          <div className="flex gap-x-7">
            ...
            <p className=" font-medium text-[1.1rem] md:text-[1.3rem] text-gray-500">{`Date: ${new Date(sheet.date).toDateString()}`}</p>
          </div>
      ...
      <div id="carousel" className="sm:bg-stone-200/30 w-auto rounded-xl flex justify-center items-center p-5">
      ...
      <div id="comment" className="bg-violet-200">comment</div>
    </div>
