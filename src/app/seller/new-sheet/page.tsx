...
export default function NewSheet() {
  ...
  const handleInputChange = (
    ...
    setSheet((prevSheet) => ({
      ...prevSheet,
      [name]:
        name !== "price" && name !== "num_page" ? value : parseInt(value, 10),
    }));
  };
  ...
  return (
    <div className="flex justify-center items-center z-10 mb-6">
      <form
        className="relative flex flex-col m-6 space-y-8 bg-white drop-shadow-2xl md:flex-row md:space-y-0 rounded-xl lg: w-4/4"
        ...
        <div className="space-y-12 p-10 rounded-s-md">
          <div className="border-b border-gray-900/10 pb-12">
            <div className=" flex gap-1 items-center">
              ...
              <h2 className=" text-xl text-gray-700 font-bold leading-7 uppercase ">
                Add new sheets
              </h2>
            </div>
              ...
              <div className="col-span-full">
                ...
                <div className="mt-2">
                  <textarea
                    ...
                    onChange={handleInputChange}
                    name="suggestion"
                    placeholder="ให้คำแนะนำเกี่ยวกับชีทนี้"
                    rows={3}
              ...
              <div className="col-span-6">
                ...
                <div className="mt-2">
                  <UploadSamplePage
                    ...
                    buttonDelete={isUpload}
                    setCheckImageList={setCheckImageList}
                  />
                </div>
              </div>
              <div className="col-span-6">
          ...
          <button
            className="w-full border border-gray-300 text-md p-2 rounded-lg mb-6 hover:bg-amber-500 hover:text-white"
            hidden={!(checkFile && checkImage && checkImageList)}
          >
            🚀✨Add new sheet!!✨
          </button>
        </div>
