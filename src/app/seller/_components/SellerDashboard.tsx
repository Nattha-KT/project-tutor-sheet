...
const SellerDashboard: React.FC<SellerDashboardProps> = ({ dataSheets }) =>  {
  ...
  const TABLE_HEAD = ["Course Name", "Price", "Status", "Date", `Total(${dataSheets.length})`];
  ...
  return (
      ...
      <CardHeader floated={false} shadow={false} className="rounded-none">
        <div className="mb-8 flex items-center justify-between gap-2 sm:gap-8">
          <div>
              <div className='ml-[-45px] flex gap-4 items-center'>
                  ...
                  <Image src={"/Icons/dollar.png"} width={200} height={200} alt='money_icon' className=' max-w-[40px] max-h-[40px] '/>
              </div>
