...
export default async function SellerPage() {
  ...
  return (
    <div
      id="dashbard-seller"
      className=" container min-w-full px-6 flex flex-col-reverse lg:flex-col gap-5 mb-10"
    >
      ...
      <div
        id="head-state"
        className=" flex flex-col lg:flex-row itemcenter md:justify-between gap-4 "
      >
      ...
      {results&&<SellerDashboard dataSheets={results} />}
    </div>
  );
}
