...
export default function CheckBox({checkbox,setCheckbox}: PropsCheckBox) {
        ...
        <div  className="inline-flex items-center">
            <label className="relative flex items-center p-3 rounded-full cursor-pointer" htmlFor="link">
                ...
                className="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none
                 rounded-md border border-blue-gray-200 transition-all before:absolute before:top-2/4 before:left-2/4 
                 before:block before:h-12 before:w-12 before:-translate-y-2/4 before:-translate-x-2/4 before:rounded-full 
                 before:bg-blue-gray-500 before:opacity-0 before:transition-opacity checked:border-gray-900 checked:bg-gray-900
            ...
            <label className="mt-px font-light text-stone-700 cursor-pointer select-none" htmlFor="link">
                <p className="flex font-sans text-sm antialiased font-normal leading-relaxed ">
                I agree with the
                <a href="#"
