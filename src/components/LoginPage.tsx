...
export default function LoginPage() {
    ...
    useEffect(() => {
        setRandomImage (Math.floor(Math.random() * (maxRange - minRange + 1)) + minRange);
      }, []);
...
return (
        ...
        <div className="flex flex-col  px-8  py-2 md:p-14">
                <div className='flex justify-start mb-4'>
                     <Image width={2000} height={2000}  src="/images/tutor-logo.png" alt="Image " className="w-20 h-20  hidden  md:block object-cover" />
                </div>
            ...
            <Image width={2000} height={2000}  src="/images/facebook.png" alt="Image " className="w-6 h-6 inline mr-2" />
            Sign in with Facebook
            </button>
            <button onClick={() => handleGoogleLogin()}
            className="w-full border border-gray-300 text-md p-2 rounded-lg mb-6 hover:bg-black hover:text-white"
            >
            <Image width={2000} height={2000}  src="/images/google.png" alt="Image " className="w-6 h-6 inline mr-2" />
            Sign in with Google
            </button>
        ...
        <div className="relative">
            ...
            onError={(e: ImageErrorEvent) => e.target.src = '/images/bg1.jpge.jpg'}
